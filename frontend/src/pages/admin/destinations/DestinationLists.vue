            ...
            <table class="min-w-180 w-full">
              ...
              <tbody>
                <tr class="text-sm text-neu-700 border-b border-neu-100">
                  ...
                  <td colspan="2" class="p-4">Beraban, Kecamatan Kediri, Kabupaten Tabanan</td>
                  <td class="p-4">081234567891</td>
                  <td class="p-4 flex gap-3">
                    <RouterLink
                      :to="{ name: 'AdminDestinationEdit', params: { id: 1 } }"
                    ...
                    <RouterLink
                      :to="{ name: 'AdminDestinationDetail', params: { id: 1 } }"
