...
<template>
  <div class="px-6 md:px-[140px]">
    ...
    <section class="mt-24 md:mt-30 flex-col flex gap-3">
      <div
        class="px-4 text-pr-500 py-2 flex gap-2 w-fit items-center justify-center text-sm md:text-base font-medium outline-pr-500 outline rounded-full"
      >
        Destinations
      </div>
      <div class="flex flex-col sm:flex-row sm:justify-between items-start">
        ...
        <div class="flex gap-2 md:gap-4 mt-3 items-center">
          <p class="text-neu-600 text-sm md:text-base max-w-full sm:max-w-80 sm:text-end">
          ...
          <div class="p-4 flex items-center justify-center bg-pr-500 rounded-full">
            <ArrowUpRight class="size-5 md:size-9 text-neu-50" />
          </div>
        </div>
      </div>
      <div class="mt-8 whitespace-nowrap">
        <div class="flex gap-8 w-fit">
          <div class="overflow-hidden w-72 md:w-[340px] h-96 md:h-[460px] rounded-4xl group">
            <div
    ...
    <section class="mt-24 md:mt-30 flex-col flex items-center">
      <div
        class="px-4 text-pr-500 py-2 flex gap-2 w-text-sm md:text-base items-center justify-center font-medium outline-pr-500 outline rounded-full"
      >
        Benefits
      </div>
      <h1
    ...
    <section class="mt-24 md:mt-30">
      <div class="flex flex-col xl:flex-row gap-8 items-center">
        <div class="w-full xl:w-5/12 flex-col items-start flex">
          <div
            class="px-4 text-pr-500 py-2 text-sm md:text-base flex gap-2 w-fit items-center justify-center font-medium outline-pr-500 outline rounded-full"
          >
            Reviews
          </div>
          <h1
            ...
            >
              <div class="flex gap-4 w-full items-center">
                ...
                <div class="gap-2 min-w-fit flex items-center">
                  ...
                  />
                  <p
                    class="hidden md:static text-neu-900 font-medium whitespace-nowrap text-xs md:text-sm"
                  >
                    Udin Surudin
                  </p>
                </div>
  ...
  <footer class="mt-24 md:mt-30 bg-neu-100 py-16 md:py-20 px-6 md:px-[140px] flex flex-col gap-8">
    <div class="flex justify-between flex-wrap items-start">
      <div class="max-w-full xl:max-w-[520px] mb-12">
        ...
        <p class="text-neu-900 text-sm md:text-base mt-2">
      ...
      <div class="flex flex-wrap text-sm md:text-base gap-10 md:gap-16">
        <div class="wrapper">
          <h3 class="text-neu-900 font-medium text-base md:text-[18px]">Explore</h3>
        ...
        <div class="wrapper">
          <h3 class="text-neu-900 font-medium text-base md:text-[18px]">Support</h3>
          <ul class="flex gap-4 flex-col mt-4.5 text-neu-800">
            <li>Help Center</li>
            <li>FAQs</li>
            <li>Contact Us</li>
        ...
        <div class="wrapper">
          <h3 class="text-neu-900 font-medium text-base md:text-[18px]">Get Inspired</h3>
          <ul class="flex gap-4 flex-col mt-4.5 text-neu-800">
    ...
    <div class="flex justify-between gap-4 flex-wrap text-sm md:text-base text-neu-900">
      <p>© 2025 Balinara. All rights reserved.</p>
      <ul class="flex gap-6 md:gap-8 underline">
