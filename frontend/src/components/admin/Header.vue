...
<template>
  ...
  <!-- Mobile Sidebar -->
  <aside
    class="fixed top-0 left-0 min-w-64 flex flex-col gap-10 p-4 min-h-screen bg-sur-50 border-r border-neu-200 z-64 transform transition-transform duration-500 ease-in-out lg:hidden"
